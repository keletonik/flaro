...
export default function Operations() {
  ...
  // Chat is handled by the shared <AnalyticsPanel /> component mounted at
  // the bottom of this component. It speaks /api/chat/agent (tool-use loop)
  // so the AI can actually create / update / delete records, not just
  // analyse them in plain text like the old inline panel did.
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Shared agent sidepanel — /api/chat/agent with real tool use */}
      <AnalyticsPanel
        section={activeTab}
