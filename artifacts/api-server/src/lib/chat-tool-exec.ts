...
const REGISTRY: Record<AgentTable, TableEntry> = {
  ...
  project_milestones: { table: projectMilestones, textCols: ["name", "description"], softDelete: false },
  project_members: { table: projectMembers, textCols: ["name", "role"], softDelete: false },
  project_activity: { table: projectActivity, textCols: ["action", "summary", "actor"], softDelete: false },
