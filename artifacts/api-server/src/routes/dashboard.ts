  ...
  try {
    ...
    try {
      const response = await anthropic.messages.create({
        ...
        messages: [{
          role: "user",
          content: `You are Casper's personal operations assistant. Based on the following open jobs and notes, generate 3-5 concise bullet points for today's focus. Be direct and prioritise urgently. Australian English.
