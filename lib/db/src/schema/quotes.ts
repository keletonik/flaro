...
export const quotes = pgTable("quotes", {
  ...
  status: text("status").notNull().$type<"To Quote" | "Draft" | "Sent" | "Accepted" | "Declined" | "Expired" | "Revised">().default("To Quote"),
  urgency: text("urgency").$type<"Urgent" | "This Week" | "Normal" | "Low">().default("Normal"),
